...
func Open(name string, cfg *carbon.Database) (*entsql.Driver, error) {
	...
	if cfg.AuthMethod == carbon.Database_AUTH_METHOD_AWS_IAM {
...
func NewOptions(cfg *carbon.Database, statsd *statsd.Client) *DriverOptions {
