...
func (qq *QuestionQuery) QueryScenario() *ScenarioQuery {
	query := (&ScenarioClient{config: qq.config}).Query()
...
func (qq *QuestionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (qq *QuestionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (qq *QuestionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (qq *QuestionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := qq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (qq *QuestionQuery) WithScenario(opts ...func(*ScenarioQuery)) *QuestionQuery {
	query := (&ScenarioClient{config: qq.config}).Query()
...
func (qq *QuestionQuery) loadScenario(ctx context.Context, query *ScenarioQuery, nodes []*Question, init func(*Question), assign func(*Question, *Scenario)) error {
...
func (qq *QuestionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(question.Table, question.Columns, sqlgraph.NewFieldSpec(question.FieldID, field.TypeUint64))
	_spec.From = qq.sql
...
func (qq *QuestionQuery) ForUpdate(opts ...sql.LockOption) *QuestionQuery {
...
func (qq *QuestionQuery) ForShare(opts ...sql.LockOption) *QuestionQuery {
	if qq.driver.Dialect() == dialect.Postgres {
		qq.Unique(false)
	}
	qq.modifiers = append(qq.modifiers, func(s *sql.Selector) {
